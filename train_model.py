...
file_path ="animal_disease_dataset.csv"  # Update this with the correct CSV file path
df = pd.read_csv(file_path)  # Load CSV instead of Excel
df.columns = df.columns.str.strip()  # Removes any accidental hidden spaces
# ---- ADD THIS LINE HERE ----
print("EXACT CSV COLUMNS ARE:", list(df.columns))
